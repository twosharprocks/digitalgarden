...
![OSCP - Cockpit - Linux - image1](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image1.png)
...
![OSCP - Cockpit - Linux - image2](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image2.png)
- Navigated to `http://192.168.244.10/blocked.html`
![OSCP - Cockpit - Linux - image3](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image3.png)
- Viewed source for `http://192.168.244.10/blocked.html` and found no further information
![OSCP - Cockpit - Linux - image4](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image4.png)
...
![OSCP - Cockpit - Linux - image5](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image5.png)
- Navigated to `http://192.168.244.10/login.php` and identified `Blaze` login - attempted login with credentials `admin:admin`
![OSCP - Cockpit - Linux - image6](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image6.png)
...
![OSCP - Cockpit - Linux - image7](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image7.png)
...
![OSCP - Cockpit - Linux - image8](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image8.png)
...
![OSCP - Cockpit - Linux - image9](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image9.png)
![OSCP - Cockpit - Linux - image10](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image10.png)
## Port 9090 - zeus-admin
- Navigated to `http://192.168.244.10:9090` and received invalid security certificate warning
![OSCP - Cockpit - Linux - image11](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image11.png)
- Viewed Certificate and identified potential MD5 hash in `Organisation`
![OSCP - Cockpit - Linux - image12](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image12.png)
...
![OSCP - Cockpit - Linux - image13](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image13.png)
- Proceeded to website and identified server login interface and `Ubuntu 20.04.6 LTS`
![OSCP - Cockpit - Linux - image14](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image14.png)
- Checked page source and identified script for "Cockpit" login
![OSCP - Cockpit - Linux - image15](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image15.png)
- Attempted password guessing with credentials `admin:admin`
![OSCP - Cockpit - Linux - image16](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image16.png)
- Attempted password guessing with credentials `admin:password`
![OSCP - Cockpit - Linux - image17](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image17.png)
- Attempted login with credentials `james:canttouchhhthiss@455152`
![OSCP - Cockpit - Linux - image18](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image18.png)
- Attempted login with credentials `cameron:thisscanttbetouchedd@455152`
![OSCP - Cockpit - Linux - image19](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image19.png)

---
# Exploitation
- Reattempted login with credentials `james:canttouchhhthiss@455152`
![OSCP - Cockpit - Linux - image20](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image20.png)
- Identified "Terminal" and achieved command execution on target - ran `cat local.txt` to print `fa9343d03bf9cbb2e6ae3c5af22043dc`
![OSCP - Cockpit - Linux - image21](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image21.png)
...
![OSCP - Cockpit - Linux - image22](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image22.png)
![OSCP - Cockpit - Linux - image23](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image23.png)

---
# Privilege Escalation
## Local Enumeration
- Ran `sudo -l` and identified `james` can run `/usr/bin/tar -czvf /tmp/backup.tar.gz *` as root without a password
![OSCP - Cockpit - Linux - image24](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image24.png)
- Identified [GTFObin for `tar`](https://gtfobins.github.io/gtfobins/tar/) using `sudo`
![OSCP - Cockpit - Linux - image25](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image25.png)
...
![OSCP - Cockpit - Linux - image26](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image26.png)
- Ran command `sudo /usr/bin/tar -czvf /tmp/backup.tar.gz *` 
![OSCP - Cockpit - Linux - image27](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image27.png)
...
![OSCP - Cockpit - Linux - image28](/files/OSCP%20-%20Cockpit%20-%20Linux%20-%20image28.png)
---
# Trophy & Loot
