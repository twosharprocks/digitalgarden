---
title: ChatGPT - Cave Diving Potential SA
created: 2025-06-14
updated: 2025-10-30
status: seed
draft: false
...
---
### 1. **Southern Yorke Peninsula (Innes National Park and Surrounds)**

**Geological context:**  
The Bridgewater Formation here includes coastal limestone dune systems. Potential exists for freshwater lenses over seawater creating submerged cave systems.
...
**Justification:**  
These areas have limited recorded cave exploration, but significant karst indicators (surface depressions, dry valleys, springs, and resurgences) strongly suggest undiscovered submerged cave systems, particularly where groundwater discharges near coastal cliffs.
...
**Justification:**  
Existing caves (e.g., Kelly Hill caves) confirm local karst processes. The nearby coastal region remains largely unexplored underwater. Potential coastal groundwater discharge and cave connections to freshwater lenses merit detailed exploration.

---

### 4. **Eyre Peninsula Limestone Coast (Coffin Bay National Park)**

**Geological context:**  
Miocene to Pleistocene Bridgewater Formation and Tertiary Gambier Limestone form extensive coastal limestone deposits. High probability of freshwater lenses and coastal karstification.
...
**Justification:**  
This coastal region exhibits numerous coastal solution cavities, sinkholes, and dolines. The area has substantial freshwater recharge and coastal karst morphology conducive to submerged cave formation, but underwater caves remain under-documented.

---

### Recommended Exploration Approach:

- Conduct initial **remote sensing** surveys (aerial LiDAR, satellite imaging, geophysical surveys) focusing on identified coordinates.
    
- Ground-truth promising sites for surface karst indicators, particularly sinkholes, dolines, freshwater springs, and coastal resurgences.
