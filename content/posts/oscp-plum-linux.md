...
![OSCP - Plum - Linux - image1](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image1.png)
...
![OSCP - Plum - Linux - image2](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image2.png)
...
![OSCP - Plum - Linux - image3](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image3.png)

---
# Exploitation
- Navigated to "Static pages" (http://192.168.164.28/core/admin/statiques.php) and selected "Edit" for static page 001
![OSCP - Plum - Linux - image4](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image4.png)
- Replaced PHP code with reverse shell script and saved page
![OSCP - Plum - Linux - image5](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image5.png)
...
![OSCP - Plum - Linux - image6](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image6.png)
- Navigated to home directory of `www-data` and ran `cat /var/www/local.txt` to print `7d958bdaf701e8151b53669070f6cfc2`
![OSCP - Plum - Linux - image7](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image7.png)
---
# Privilege Escalation
## Local Enumeration
- Ran `cat /etc/passwd` to identify any other users
![OSCP - Plum - Linux - image8](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image8.png)
- Ran `sudo -l` and identified `www-data` requires password to run `sudo`
![OSCP - Plum - Linux - image9](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image9.png)
- Downloaded `linpeas.sh` to target machine and ran `./linpeas.sh`
![OSCP - Plum - Linux - image10](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image10.png)
- Identified files with interesting permissions
![OSCP - Plum - Linux - image11](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image11.png)
- Identified interesting SGIDs
![OSCP - Plum - Linux - image12](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image12.png)
- Interesting files in others home
![OSCP - Plum - Linux - image13](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image13.png)
## Privilege Escalation vector
- Identified `exim4` as mail service, so navigated to `/var/mail` to check any available mail
![OSCP - Plum - Linux - image14](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image14.png)
- Identified and viewed mail for user `www-data` with command `cat /var/mail/www-data`
![OSCP - Plum - Linux - image15](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image15.png)
...
![OSCP - Plum - Linux - image16](/files/OSCP%20-%20Plum%20-%20Linux%20-%20image16.png)
