...
![OSCP - Algernon - Windows - image1](/files/OSCP%20-%20Algernon%20-%20Windows%20-%20image1.png)
- Enumerated available directories and downloaded `/Logs/2020.05.12-administrative.log`
![OSCP - Algernon - Windows - image2](/files/OSCP%20-%20Algernon%20-%20Windows%20-%20image2.png)
- Ran `cat 2020.05.12-administrative.log` and identified username `admin` logging into `192.168.118.6`
![OSCP - Algernon - Windows - image3](/files/OSCP%20-%20Algernon%20-%20Windows%20-%20image3.png)
## Port 80 - HTTP (Microsoft IIS)
- Navigated to `http://192.168.191.65:80` and identified default page for `Microsoft IIS`
![OSCP - Algernon - Windows - image4](/files/OSCP%20-%20Algernon%20-%20Windows%20-%20image4.png)
...
![OSCP - Algernon - Windows - image5](/files/OSCP%20-%20Algernon%20-%20Windows%20-%20image5.png)
- Ran `gobuster dir -u http://192.168.191.65:9998 -w //usr/share/dirb/wordlists/big.txt` to identify any available web directories
![OSCP - Algernon - Windows - image6](/files/OSCP%20-%20Algernon%20-%20Windows%20-%20image6.png)
---
# Exploitation
Ran `searchsploit SmarterMail` and identified exploit `49216.py` as potential initial access vector
![OSCP - Algernon - Windows - image7](/files/OSCP%20-%20Algernon%20-%20Windows%20-%20image7.png)
- Modified exploit `49216.py` to use target & local IP, and ran `nc -nvlp 80` to start netcat listener on port `80`
![OSCP - Algernon - Windows - image8](/files/OSCP%20-%20Algernon%20-%20Windows%20-%20image8.png)
- Ran `python3 49216.py` and caught reverse shell as `system` with netcat
![OSCP - Algernon - Windows - image9](/files/OSCP%20-%20Algernon%20-%20Windows%20-%20image9.png)
...
![OSCP - Algernon - Windows - image10](/files/OSCP%20-%20Algernon%20-%20Windows%20-%20image10.png)
