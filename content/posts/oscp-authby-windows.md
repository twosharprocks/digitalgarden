...
![OSCP - Authby - Windows - image1](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image1.png)
- Change directory to `accounts` and identified three `uac` accounts including `admin` and `Offsec`
![OSCP - Authby - Windows - image2](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image2.png)
- Navigated to `/` directory and unsuccessfully attempted to run `get settings.ini`
![OSCP - Authby - Windows - image3](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image3.png)
...
![OSCP - Authby - Windows - image4](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image4.png)
- Ran `ftp 192.168.171.46` with credentials `admin:admin` and identified three available files
![OSCP - Authby - Windows - image5](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image5.png)
- Used `get` to download all three files and inspected individually. 
	- Ran `cat index.php` - identified a quote from Plautus
![OSCP - Authby - Windows - image6](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image6.png)
	- Ran `cat .htaccess`
![OSCP - Authby - Windows - image7](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image7.png)
	- Ran `cat .htpasswd` - identified password hash for user `offsec:offsec:$apr1$oRfRsc/K$UpYpplHDlaemqseM39Ugg0`
![OSCP - Authby - Windows - image8](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image8.png)
...
![OSCP - Authby - Windows - image9](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image9.png)
## Port 242 - HTTP (Apache/2.2.21)
- Navigated to `http://192.168.171.46:242` and identified web login
![OSCP - Authby - Windows - image10](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image10.png)
...
![OSCP - Authby - Windows - image11](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image11.png)
## Port 3389 - RDP 
- Attempted login with cracked credentials `offsec:elite` - unsuccessful
![OSCP - Authby - Windows - image12](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image12.png)

---
# Exploitation
- Created `shell.php` with reverse shell back to Kali host
![OSCP - Authby - Windows - image13](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image13.png)
- Ran `put shell.php` on `ftp` service as `admin` to upload reverse shell
![OSCP - Authby - Windows - image14](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image14.png)
...
![OSCP - Authby - Windows - image15](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image15.png)
---
# Lateral Movement to user
## Local Enumeration
- Navigated to `C:\Users\apache\Desktop` and ran `type local.txt` to print `98e8a3c01c8d7944c46cf806438ed074`
![OSCP - Authby - Windows - image16](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image16.png)
...
![OSCP - Authby - Windows - image17](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image17.png)
---
...
![OSCP - Authby - Windows - image18](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image18.png)
- Checked reverse shell and found incoming connection
![OSCP - Authby - Windows - image19](/files/OSCP%20-%20Authby%20-%20Windows%20-%20image19.png)
