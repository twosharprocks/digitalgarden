...
![OSCP Astronaut Linux Image1](/images/OSCP%20-%20Astronaut%20-%20Linux%20-%20image1.png)
- Found default installation page for `grav-admin`
	- *Grav CMS is vulnerable to CVE-2021-21425  (Unauthenticated RCE)*
![OSCP Astronaut Linux Image2](/images/OSCP%20-%20Astronaut%20-%20Linux%20-%20image2.png)
- Returned to terminal and ran `gobuster` against target:
 ...
 ![OSCP Astronaut Linux Image3](/images/OSCP%20-%20Astronaut%20-%20Linux%20-%20image3.png)
---
# Exploitation
## CVE-2021-21425  (Unauthenticated RCE)
- Identified exploit `49973.py`
- Modified exploit to suit target and local system
![OSCP Astronaut Linux Image4](/images/OSCP%20-%20Astronaut%20-%20Linux%20-%20image4.png)
...
![OSCP Astronaut Linux Image5](/images/OSCP%20-%20Astronaut%20-%20Linux%20-%20image5.png)
---
# Lateral Movement to user
## Local Enumeration
- Enumerated files to find `admin` user with password hash `$2y$10$dlTNg17RfN4pkRctRm1m2u8cfTHHz7Im.m61AYB9UtLGL2PhlJwe.`
![OSCP Astronaut Linux Image6](/images/OSCP%20-%20Astronaut%20-%20Linux%20-%20image6.png)
	- Hash identified as `bcrypt`
![OSCP Astronaut Linux Image7](/images/OSCP%20-%20Astronaut%20-%20Linux%20-%20image7.png)
...
![OSCP Astronaut Linux Image8](/images/OSCP%20-%20Astronaut%20-%20Linux%20-%20image8.png)
	- Identified user `alex:x:1000:1000::/home/alex:/bin/bash`
		- Unable to access `/home/alex`
		![OSCP Astronaut Linux Image9](/images/OSCP%20-%20Astronaut%20-%20Linux%20-%20image9.png)
---
# Privilege Escalation
## Local Enumeration
Attempted to upload `linpeas.sh` without success
![OSCP Astronaut Linux Image10](/images/OSCP%20-%20Astronaut%20-%20Linux%20-%20image10.png)
Enumerated binary permissions
![OSCP Astronaut Linux Image11](/images/OSCP%20-%20Astronaut%20-%20Linux%20-%20image11.png)
...
![OSCP Astronaut Linux Image12](/images/OSCP%20-%20Astronaut%20-%20Linux%20-%20image12.png)
---
# Trophy & Loot
`flag1.txt` = `T2Zmc2Vj`
