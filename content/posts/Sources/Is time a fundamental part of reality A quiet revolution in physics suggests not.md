---
title: "Is time a fundamental part of reality A quiet revolution in physics suggests not"
source: "https://theconversation.com/is-time-a-fundamental-part-of-reality-a-quiet-revolution-in-physics-suggests-not-273841"
author:
  - "Florian Neukart"
...
And yet, for more than a century, physics [has struggled to say what time actually is](https://theconversation.com/great-mysteries-of-physics-1-is-time-an-illusion-201026). This struggle is not philosophical nitpicking. It sits at the heart of some of the deepest problems in science.

Modern physics relies on different, but equally important, frameworks. One is Albert Einstein’s [theory of general relativity](https://theconversation.com/how-einsteins-general-theory-of-relativity-killed-off-common-sense-physics-50042), which describes the gravity and motion of large objects such as planets. Another is [quantum mechanics](https://theconversation.com/quantum-physics-our-study-suggests-objective-reality-doesnt-exist-126805), which rules the microcosmos of atoms and particles. And on an even larger scale, [the standard model of cosmology](https://theconversation.com/cosmology-is-at-a-tipping-point-we-may-be-on-the-verge-of-discovering-new-physics-237695) describes the birth and evolution of the universe as a whole. All rely on time, yet they treat it in incompatible ways.

When physicists try to combine these theories into a single framework, time often behaves in unexpected and troubling ways. Sometimes it stretches. Sometimes it slows. Sometimes it [disappears entirely](https://link.springer.com/chapter/10.1007/978-94-011-1980-1_6).

---

![](https://images.theconversation.com/files/313478/original/file-20200204-41481-1n8vco4.png?ixlib=rb-4.1.0&q=45&auto=format&w=600&h=112&fit=crop&dpr=1)

*The [Insights section](https://theconversation.com/uk/insights) is committed to high-quality [longform journalism](https://theconversation.com/insights-the-conversations-long-reads-section-240155). Our editors work with academics from many different backgrounds who are tackling a wide range of societal and scientific challenges.*
...
***Read more: [Quantum mechanics: how the future might influence the past](https://theconversation.com/quantum-mechanics-how-the-future-might-influence-the-past-199426)***

---

This mismatch becomes acute when physicists try to describe gravity at the quantum level, which is crucial for developing the much coveted [theory of everything](https://theconversation.com/great-mysteries-of-physics-do-we-really-need-a-theory-of-everything-203534) – which links the main fundamental theories. But in many attempts to create such a theory, time vanishes as a parameter from the fundamental equations altogether. The universe appears frozen, described by equations that make no reference to change.
...
Now a relatively new approach to physics, building on a mathematical framework called information theory, [developed by Claude Shannon](https://www.quantamagazine.org/how-claude-shannons-information-theory-invented-the-future-20201222/) in the 1940s, has started coming up with surprising answers.

## Entropy and the arrow of time

When physicists try to explain the direction of time, [they often turn](https://theconversation.com/what-is-time-and-why-does-it-move-forward-55065) to a concept called entropy. The second law of thermodynamics states that disorder tends to increase. A glass can fall and shatter into a mess, but the shards never spontaneously leap back together. This asymmetry between past and future is often identified with [the arrow of time](https://global.oup.com/academic/product/times-arrow-and-archimedess-point-9780195117981).
...
![Spools of coloured embroidery threads. Huge knot is haphazardly braided.](https://images.theconversation.com/files/713594/original/file-20260121-56-7gxmer.jpg?ixlib=rb-4.1.0&q=45&auto=format&w=600&h=450&fit=crop&dpr=1)

It is hard to undo a mess. klevo/Shutterstock
...
In parallel, surprising connections emerged between gravity and thermodynamics. It was shown that Einstein’s equations [can be derived from](https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.75.1260) thermodynamic principles that link spacetime geometry directly to entropy and information. In this view, gravity doesn’t behave exactly like a fundamental force.
...
Similarly, gravity can be described as an emergent phenomenon, arising from statistical processes. Some physicists have even suggested that gravity itself [may emerge from information](https://link.springer.com/article/10.1007/JHEP04\(2011\)029), reflecting how information is distributed, encoded and processed.
...
Interestingly, this accumulated imprint of information may have observable consequences. At galactic scales, the residual information imprint [behaves like an additional gravitational component](https://www.preprints.org/manuscript/202504.2379/v1), shaping how galaxies rotate without invoking new particles. Indeed, the unknown substance called dark matter was introduced to explain why galaxies and galaxy clusters rotate faster than their visible mass alone would allow.
...
![Image of the Andromeda Galaxy.](https://images.theconversation.com/files/713599/original/file-20260121-66-uz7zjw.jpg?ixlib=rb-4.1.0&q=45&auto=format&w=600&h=338&fit=crop&dpr=1)

Galaxies rotate faster than they should. Wirestock Creators/Shutterstock
...
Black holes provide a natural testing ground, as they seems to suggest information is erased. In the informational framework, this conflict is resolved by recognising that information is not destroyed [but imprinted into spacetime](https://www.mdpi.com/1099-4300/26/12/1039) before crossing the horizon. The black hole records it.
...
*For you: more from our :*

- *[Inside Porton Down: what I learned during three years at the UK’s most secretive chemical weapons laboratory](https://theconversation.com/inside-porton-down-what-i-learned-during-three-years-at-the-uks-most-secretive-chemical-weapons-laboratory-248376)*
- *[The overshoot myth: you can’t keep burning fossil fuels and expect scientists of the future to get us back to 1.5°C](https://theconversation.com/the-overshoot-myth-you-cant-keep-burning-fossil-fuels-and-expect-scientists-of-the-future-to-get-us-back-to-1-5-c-230814)*
- *[Our quest to find a truly Earth-like planet in deep space](https://theconversation.com/our-quest-to-find-a-truly-earth-like-planet-in-deep-space-266550)*
- *[Sex machina: in the wild west world of human-AI relationships, the lonely and vulnerable are most at risk](https://theconversation.com/sex-machina-in-the-wild-west-world-of-human-ai-relationships-the-lonely-and-vulnerable-are-most-at-risk-239783)*

*To hear about new Insights articles, join the hundreds of thousands of people who value The Conversation’s evidence-based news. [**Subscribe to our newsletter**](https://theconversation.com/uk/newsletters/the-daily-newsletter-2?utm_source=TCUK&utm_medium=linkback&utm_campaign=TCUKengagement&utm_content=InsightsUK).*

### Events

- [A lost US military base under Greenland's ice sheet — Victoria](https://theconversation.com/au/events/a-lost-us-military-base-under-greenlands-ice-sheet-10170)
- [Politics with Michelle Grattan Podcast — Australian Capital Territory](https://theconversation.com/au/events/politics-with-michelle-grattan-podcast-10461)
- [CSIRO ON Prime: Explore where your research can make the greatest impact. Applications now open!](https://theconversation.com/au/events/csiro-on-prime-explore-where-your-research-can-make-the-greatest-impact-applications-now-open-15261)
- [Certification Short Course — Sydney, New South Wales](https://theconversation.com/au/events/certification-short-course-15294)
- [Development Assessment Course — Sydney, New South Wales](https://theconversation.com/au/events/development-assessment-course-15298)
[More events](https://theconversation.com/au/events)