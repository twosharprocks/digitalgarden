...
![OSCP Rubydome Linux Image1](/images/OSCP%20-%20RubyDome%20-%20Linux%20-%20image1.png)
- Attempted to get PDF for `http://127.0.0.1`, received error for `PDFKit`
![OSCP Rubydome Linux Image2](/images/OSCP%20-%20RubyDome%20-%20Linux%20-%20image2.png)
- Identified PDFKit version (0.8.6) (required expanding "Backtrace" details)
- Identified PDFKit uses url for POST parameter
![OSCP Rubydome Linux Image3](/images/OSCP%20-%20RubyDome%20-%20Linux%20-%20image3.png)
---
# Exploitation
## Command Injection
...
- Ran exploit command;
  ...
  ![OSCP Rubydome Linux Image4](/images/OSCP%20-%20RubyDome%20-%20Linux%20-%20image4.png)
- Caught reverse shell as `andrew` with Netcat listener
![OSCP Rubydome Linux Image5](/images/OSCP%20-%20RubyDome%20-%20Linux%20-%20image5.png)

---
# Lateral Movement to user
## Local Enumeration
- Upgrade to full TTY, moved to `andrew` home directory, printed `local.txt`
![OSCP Rubydome Linux Image6](/images/OSCP%20-%20RubyDome%20-%20Linux%20-%20image6.png)
- Ran `cat /etc/passwd` to also find `offsec` user
![OSCP Rubydome Linux Image7](/images/OSCP%20-%20RubyDome%20-%20Linux%20-%20image7.png)
- Ran `sudo -l` to find `andrew` has sudo privilege for `/usr/bin/ruby`
![OSCP Rubydome Linux Image8](/images/OSCP%20-%20RubyDome%20-%20Linux%20-%20image8.png)
- Ran `ls -lah` inside `/app` directory and identified `andrew` has `rwx` privilege over `app.rb`
![OSCP Rubydome Linux Image9](/images/OSCP%20-%20RubyDome%20-%20Linux%20-%20image9.png)
---
...
![OSCP Rubydome Linux Image10](/images/OSCP%20-%20RubyDome%20-%20Linux%20-%20image10.png)
- Echoed `exec "/bin/sh"` into `app.rb` 
![OSCP Rubydome Linux Image11](/images/OSCP%20-%20RubyDome%20-%20Linux%20-%20image11.png)
- Ran `app.rb` as Sudo to achieve `root`
![OSCP Rubydome Linux Image12](/images/OSCP%20-%20RubyDome%20-%20Linux%20-%20image12.png)

---
# Trophy & Loot
`local.txt` = `a779352dd3270666856f7cbd34073f4b`
`root.txt` = `78aba0e8e3abe4e15304b6fda4649006`
![OSCP Rubydome Linux Image13](/images/OSCP%20-%20RubyDome%20-%20Linux%20-%20image13.png)
