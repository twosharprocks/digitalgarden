...
![OSCP Image Linux Image1](/images/OSCP%20-%20Image%20-%20Linux%20-%20image1.png)
...
![OSCP Image Linux Image2](/images/OSCP%20-%20Image%20-%20Linux%20-%20image2.png)
- Ran `gobuster dir -u  http://192.168.201.178 -w //usr/share/dirb/wordlists/big.txt` to try to identify other web directories
![OSCP Image Linux Image3](/images/OSCP%20-%20Image%20-%20Linux%20-%20image3.png)
---
# Exploitation
...
![OSCP Image Linux Image4](/images/OSCP%20-%20Image%20-%20Linux%20-%20image4.png)
- Uploaded file to `ImageMagick` web server
![OSCP Image Linux Image5](/images/OSCP%20-%20Image%20-%20Linux%20-%20image5.png)
- Caught reverse shell as `www-data` user
![OSCP Image Linux Image6](/images/OSCP%20-%20Image%20-%20Linux%20-%20image6.png)
---
# Privilege Escalation
## Local Enumeration
- Navigated to `/var/www` and printed `local.txt`
![OSCP Image Linux Image7](/images/OSCP%20-%20Image%20-%20Linux%20-%20image7.png)
## Privilege Escalation vector
- Ran `which strace` and `ls -lah /usr/bin/strace` to check `strace` privilege, finding SUID bit is set
![OSCP Image Linux Image8](/images/OSCP%20-%20Image%20-%20Linux%20-%20image8.png)
- Checked GTFObins to find `strace` with SUID bit set can be used for privilege escalation, and used it to achieve root
![OSCP Image Linux Image9](/images/OSCP%20-%20Image%20-%20Linux%20-%20image9.png)
---
# Trophy & Loot
