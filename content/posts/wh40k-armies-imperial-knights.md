...
### **Lords of War**
1. **Knight Castellan** – 600 pts ([Dominus chassis](https://www.amazon.com.au/GAMES-WORKSHOP-54-21-Imperial-Knights/dp/B09ZYS4W54/ref=sr_1_4))
    - Equipped with a **Plasma Decimator**, **Volcano Lance**, and support weapons.
2. **Knight Paladin** – 450 pts ([Questoris chassis](https://www.amazon.com.au/Warhammer-Imperial-Knights-Knight-Questoris/dp/B0BH3MFKHL/ref=sr_1_2_mod_primary_new))
    - Armed with a **Rapid-Fire Battle Cannon** and **Thunderstrike Gauntlet**.
3. **Knight Gallant** – 400 pts ([Questoris chassis](https://www.amazon.com.au/Warhammer-Imperial-Knights-Knight-Questoris/dp/B0BH3MFKHL/ref=sr_1_2_mod_primary_new))
    - Focused on melee with a **Reaper Chainsword** and **Thunderstrike Gauntlet**.
4. **2x Armiger Warglaives** – 300 pts (150 pts each)
    - Each equipped with a **Thermal Spear** and **Reaper Chain-Cleaver**.
5. **2x Armiger Helverins** – 300 pts (150 pts each)
