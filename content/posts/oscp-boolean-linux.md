...
![OSCP - Boolean - Linux - image1](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image1.png)
- Ran `gobuster` to enumerate directories: `gobuster dir -u  http://192.168.137.231 -w //usr/share/dirb/wordlists/big.txt`
![OSCP - Boolean - Linux - image2](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image2.png)
- Used `gobuster` to further enumerate `filemaneger` directory with no results
![OSCP - Boolean - Linux - image3](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image3.png)

---
# Exploitation
- Created user with credentials `offsec:password` & email `offsec@offsec.com`
![OSCP - Boolean - Linux - image4](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image4.png)
...
![OSCP - Boolean - Linux - image5](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image5.png)
- Modified request to include `&user%5Bconfirmed=True` and bypassed email confirmation
Request (Burpsuite)
![OSCP - Boolean - Linux - image6](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image6.png)
Response (Browser)
![OSCP - Boolean - Linux - image7](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image7.png)
- Identified upload facility, so created reverse shell with MSFVenom
![OSCP - Boolean - Linux - image8](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image8.png)
- Successfully uploaded shell.php to target
![OSCP - Boolean - Linux - image9](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image9.png)
...
![OSCP - Boolean - Linux - image10](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image10.png)
...
![OSCP - Boolean - Linux - image11](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image11.png)
- Identified `local.txt` and accessed `.ssh/keys`
![OSCP - Boolean - Linux - image12](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image12.png)
- Downloaded `root`, `id_rsa`, `id_rsa.1`, `id_rsa.2` SSH keys & attempted to crack password
![OSCP - Boolean - Linux - image13](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image13.png)![OSCP - Boolean - Linux - image14](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image14.png)
- Used `ssh-keygen` to generate an authorized key
![OSCP - Boolean - Linux - image15](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image15.png)
- Uploaded newly generated key `authorized_keys` to target
![OSCP - Boolean - Linux - image16](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image16.png)
- Used newly generated SSH key to login as `remi` user
![OSCP - Boolean - Linux - image17](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image17.png)
---
...
![OSCP - Boolean - Linux - image18](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image18.png)
- Used SSH to switch to `root`: `ssh -i root root@127.0.0.1 -o IdentitiesOnly=yes`
![OSCP - Boolean - Linux - image19](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image19.png)
- Navigated to `/root` to find `proof.txt`
![OSCP - Boolean - Linux - image20](/files/OSCP%20-%20Boolean%20-%20Linux%20-%20image20.png)
---
# Trophy & Loot
